...
class AdmsLogin extends AdmsConn
{
    ...
    public function login(array $data = null)
    {
        ...
        // Instanciar o método quando a classe é abstrata e a classe AdmsLogin é filha da classe AdmsConn
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p style='color: #f00;'>Erro: Usuário ou Senha incorretos</p>";
            $this->result = false;
            //echo $_SESSION['msg'];
        }
    }
